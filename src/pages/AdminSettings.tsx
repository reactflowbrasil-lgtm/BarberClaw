...
import { Store, CreditCard, Bell, Palette } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#050505] text-slate-100 font-sans flex">
      ...
      <main className="flex-1 overflow-y-auto pt-16 md:pt-0">
        <header className="px-8 py-6 border-b border-white/10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-[#0a0a0a]/50 backdrop-blur-md sticky top-0 z-10">
          ...
          <button className="w-full sm:w-auto bg-lime-400 text-black px-6 py-2 rounded-full text-sm font-bold hover:bg-lime-500 transition-colors">
            Salvar Alterações
          </button>
        </header>
        ...
        <div className="p-4 md:p-8 max-w-4xl">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1 flex flex-row lg:flex-col gap-2 overflow-x-auto pb-2 lg:pb-0 scrollbar-hide">
              <button className="whitespace-nowrap flex items-center gap-3 px-4 py-3 rounded-xl bg-white/10 text-white font-medium text-left">
                <Store className="w-5 h-5" /> Perfil
              </button>
              <button className="whitespace-nowrap flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:bg-white/5 hover:text-white transition-colors text-left">
              ...
              <div className="bg-white/5 border border-white/10 rounded-3xl p-6 md:p-8">
                ...
                <div className="space-y-6">
                  <div className="flex flex-col sm:flex-row items-center gap-6">
                    <div className="w-24 h-24 rounded-2xl bg-zinc-800 border-2 border-dashed border-white/20 flex items-center justify-center cursor-pointer hover:border-lime-400 transition-colors shrink-0">
